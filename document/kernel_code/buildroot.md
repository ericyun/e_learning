...
mmc_writel(mmc, 0x200100, SDMMC_DLYLINE);

#define SDMMC_DLYLINE	0x108	// Delay line register

mmc_writel(mmc, 0, SDMMC_GPIO);
mmc_writel(mmc, 0x10010000, SDMMC_DLYLINE);

mmc_writel(mmc, 0x20010000, SDMMC_DLYLINE);
